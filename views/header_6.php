...
//glfn::_pre($datacustomer);
                    ...
                    if (isset($_COOKIE[COOKIE_SIGNIN]) && ($_COOKIE[COOKIE_SIGNIN])):
                        ?>
                        <div  style="border:0px solid black;align-items: Vertical;">
                        ...
                        <div class = "float-right custom-dropdown" style="border:1px solid black;height:40px;">
                            <img class="img-fluid" style="width: 40px;height: 40px;border:3px solid #d2d2d2;" src="<?= PATH_IMAGE ?>customer/<?= $picture_customer ?>.jpg?a=<?= time() ?>" onerror="this.src='<?= PATH_IMAGE ?>customer/def-customer.jpg?a=<?= time() ?>';"  />

                            <a class = "triangle2" style="margin-left:10px;font-size:12px;" href = "<?= URL ?>user" >
                                <div class="usermenu" style="overflow: hidden;height: 40px;border:0px solid black;float: left;width:80px;padding-left:5px;">
                                    <?= $name_login_customer ?>
                                </div>
                            </a>
