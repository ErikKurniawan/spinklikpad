    ...
    <div class="container">
        ...
        if ($_code == "") {
            ...
            <div class="row" style="margin-top: 30px 0px 20px 0px;">
                <div class="col-sm-12 col-sm-12 table">
                    <div class="wrapper">	
            ...
            <div class="row">
                ...
                <div class="col-sm-9 col-lg-9 bhoechie-tab">
                    <div class="bhoechie-tab-content active">
                        ...
                        <div class="row">
                            <div class="col-sm-8 col-lg-8">
                                <form class="frm-payment" id="frmtransfer" action="<?php echo URL . 'payment/paymentdo' ?>" class="form-horizontal" method="post">
                                    ...
                                    <div class="form-group">
                                        <div class="inputGroupContainer">
                                            <button class="btn dp-btn-beli " type="submit" value="">Submit</button>
                    ...
                    <div class="bhoechie-tab-content">
                        ...
                        <div class="row">
                            <div class="col-sm-8 col-lg-8">
                                <form class="frm-payment" id="frmebank" action="<?php echo URL . 'payment/paymentdo' ?>" class="form-horizontal" method="post">
                                    <div class="form-group">
                                        <div class="inputGroupContainer"><select class="form-control cst-input" id="bank" name="bank">
                                                <?php
                                                $arraybanklist = $this->bank;
                    ...
                    <div class="bhoechie-tab-content">
                        ...
                        <div class="row">
                            <div class="col-sm-8 col-lg-8">
                                <form class="frm-payment" id="frmcc" action="<?php echo URL . 'payment/paymentdo' ?>" class="form-horizontal" method="post">
                                    <div class="form-group">
                                        <div class="inputGroupContainer">
