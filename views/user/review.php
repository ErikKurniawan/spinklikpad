        ...
        <div class="col-10">
            ...
            <div style="border:1px solid #e2e7e9;padding:10px;">
                ...
                <ul style="border-bottom:1px solid #e2e7e9;" class="nav nav-pills mb-3 i-tab" id="pills-tab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" id="pills-home-tab" href="<?= URL ?>user/review">Menunggu Ulasan</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="pills-profile-tab" href="<?= URL ?>user/reviewlist">Ulasan Saya</a>
                    </li>
                </ul>
                    ...
                    $(function () {
                        ...
                        $(".rateYo").rateYo({
                            ...
                            onSet: function (rating, rateYoInstance) {
                                ...
                                {
                                    namerating = "Sangat Baik";
                                }
                                $('#rateyoid'+key).html(namerating);
                                $('#valuerateyo'+key).val(rating);
                            }
                                        ...
                                        <form class="formsubmit" id="frmprofileedit<?=$key?>" action="<?= URL ?>user/reviewdo" method="post" enctype="multipart/form-data">
                                           ...
                                           <input type="hidden" name="cdt" value="<?=$value['_code_detail_transaction']?>" />
                                            <div class="rateY2o" style="border:0px solid red;">
                                                ...
                                                <span id="rateyoid<?=$key?>" style="font-size:15px;float:left;line-height: 25px;padding-left: 5px;color:#95999A" class="rateyo_desc">Bagaimana kualitas produk ini?</span>
                                                <input type="hidden" name="valuerateyo" id="valuerateyo<?=$key?>" value="0"/>
                                            </div>
                                            <div style="padding-top:50px;">
                                                <textarea name="ratingdesc" cols="100" rows="5" style="resize: none;"></textarea>
                                            </div>
                                            <button type="submit" class="signin">Submit ulasan</button>
