...
<section>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-sm-3 col-lg-3 left-menu">

                <ul id="Menu">

                    <li> <a  href="<?php echo URL.'account'?>" class="avatar">
                    ...
                    <li><a href="<?php echo URL.'account/purchase'?>">Pembelian</a></li>

                    <li><a href="<?php echo URL.'account/wishlist'?>">Wishlist</a></li>
            ...
            <div class="col-sm-9 col-lg-9">
                ...
                <div class="tab-contanier">
                    ...
                    <div class="title-account">Biodata Diri</div>

                    <div class="btn-tabcontainer">

                        <ul class="btn-tab">

                            <li class="active"><a href="<?php echo URL.'account'?>">Biodata Diri</a></li>

                            <li><a href="<?php echo URL.'account/password'?>">Alamat</a></li>

                            <li><a href="<?php echo URL.'account/address'?>">Alamat</a></li>

                            <li><a href="<?php echo URL.'account/address'?>">Bank</a></li>
                    ...
                    <div class="content-tab row">
                        ...
                        <div class="col-sm-8 col-lg-8">
                            ...
                            <form id="frmbiodata" class="form-horizontal" action="account/savebiodata" method="post">

                                <div class="sub-title-account">Ubah Biodata Diri</div>

                                <div class="form-group">

                                    <label class="control-label col-sm-3 col-lg-3 cst-contorl-label" >Nama</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="control-label col-sm-3 col-lg-3 cst-contorl-label">Tanggal Lahir</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="control-label col-sm-3 col-lg-3 cst-contorl-label">Jenis kelamin</label>
                                ...
                                <div class="sub-title-account">Ubah Kontak</div>

                                <div class="form-group">

                                    <label class="control-label col-sm-3 col-sm-3 cst-contorl-label">Email</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="control-label col-sm-3 col-lg-3 cst-contorl-label">Nomor HP</label>
