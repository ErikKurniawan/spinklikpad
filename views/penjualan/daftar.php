        ...
        <div class="col-10">
            ...
            <div style="border:1px solid #e2e7e9;padding:10px;">
                ...
                <ul style="border-bottom:1px solid #e2e7e9;" class="nav nav-pills mb-3 i-tab" id="pills-tab" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" id="pills-profile-tab" href="<?= URL ?>penjualan/konfirmasi">Konfirmasi Pengiriman</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" id="pills-contact-tab" href="<?= URL ?>penjualan/daftar" >Daftar Transaksi</a>
                    </li>
                    <li class="nav-item">
